...
export function BuilderHeader() {
  ...
  return (
    <header className="h-[60px] border-b border-slate-200 bg-white/80 backdrop-blur-md flex items-center px-4 lg:px-8 justify-between overflow-hidden safe-area-x">
      {/* Left: Logo */}
