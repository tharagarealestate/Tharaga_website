...
export function WorkflowTabs() {
  ...
  return (
    <div className="h-[56px] border-b border-slate-200 bg-slate-50/80 backdrop-blur-md flex items-stretch px-2 lg:px-6 overflow-x-auto">
      <div className="flex gap-2 sm:gap-4 items-stretch mx-auto">
        {WORKFLOW_CONFIG.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative inline-flex items-center gap-2 px-3 sm:px-4 text-xs sm:text-sm font-medium whitespace-nowrap rounded-none border-b-2 transition-colors duration-200",
                isActive
