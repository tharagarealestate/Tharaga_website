...
import {
  Settings, User, Bell, Shield, Plug, Globe,
  Mail, Phone, Building2, Save, ChevronRight,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          {activeTab === 'profile' && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-zinc-900/60 border border-zinc-800/60 rounded-xl p-6 space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input className="w-full px-3 py-2 bg-zinc-900/80 border border-zinc-800 rounded-lg text-sm text-zinc-300 focus:outline-none focus:border-amber-500/40" defaultValue="Tharaga Real Estate" />
                </div>
                <div>
                  <label className="block text-xs text-zinc-500 mb-1.5">Contact Email</label>
                  <input className="w-full px-3 py-2 bg-zinc-900/80 border border-zinc-800 rounded-lg text-sm text-zinc-300 focus:outline-none focus:border-amber-500/40" defaultValue="info@tharaga.co.in" />
                </div>
                <div>
                  <label className="block text-xs text-zinc-500 mb-1.5">Phone</label>
                  <input className="w-full px-3 py-2 bg-zinc-900/80 border border-zinc-800 rounded-lg text-sm text-zinc-300 focus:outline-none focus:border-amber-500/40" defaultValue="+91 98765 43210" />
                </div>
                <div>
                  <label className="block text-xs text-zinc-500 mb-1.5">Location</label>
                  <input className="w-full px-3 py-2 bg-zinc-900/80 border border-zinc-800 rounded-lg text-sm text-zinc-300 focus:outline-none focus:border-amber-500/40" defaultValue="Chennai, Tamil Nadu" />
                </div>
              </div>
              <button className="flex items-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-400 text-zinc-950 rounded-lg text-sm font-semibold transition-colors">
          ...
          {activeTab === 'notifications' && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-zinc-900/60 border border-zinc-800/60 rounded-xl p-6 space-y-4">
          ...
          {activeTab === 'integrations' && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
              ...
              {[
                { name: 'WhatsApp Business', description: 'Send messages to leads via WhatsApp', connected: true, icon: MessageSquare },
                { name: 'Google Ads', description: 'Import leads from Google Ads campaigns', connected: true, icon: Globe },
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-zinc-900/60 border border-zinc-800/60 rounded-xl p-6 space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input className="w-full px-3 py-2 bg-zinc-900/80 border border-zinc-800 rounded-lg text-sm text-zinc-300 focus:outline-none focus:border-amber-500/40" placeholder="TN/01/2024/XXXX" />
                </div>
                <div>
