...
export async function GET(request: NextRequest) {
  try {
    ...
    const { user, isAdmin, serviceClient: svc } = authed
    ...
    const res = NextResponse.json({
      totalLeads, hotLeads, warmLeads, totalProperties, activeProperties,
      totalViews, totalInquiries, conversionRate: parseFloat(conversionRate),
