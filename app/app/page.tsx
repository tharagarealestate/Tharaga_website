...
export default function HomePage() {
  return (
    <div className="homepage-header min-h-screen relative overflow-hidden bg-gradient-to-br from-primary-950 via-primary-900 to-primary-800">
      ...
      <main className="hero-premium relative z-10">
        <div className="inner">
          {/* Hero Section */}
