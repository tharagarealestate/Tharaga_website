      ...
      <div className="relative z-10">
        <main className="mx-auto max-w-4xl px-6 sm:px-8 py-8 sm:py-12">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-cyan-500/20 via-cyan-600/20 to-cyan-500/20 glow-border rounded-xl p-6 sm:p-8 text-center">
              <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">
                Property Valuation
              </h1>
              <p className="text-lg sm:text-xl text-slate-300">
                Get accurate property valuation with RERA integration and market analysis
              </p>
            </div>
