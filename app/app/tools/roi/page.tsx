      ...
      <div className="relative z-10">
        <main className="mx-auto max-w-4xl px-6 sm:px-8 py-8 sm:py-12">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-amber-500/20 via-amber-600/20 to-amber-500/20 glow-border rounded-xl p-6 sm:p-8 text-center">
              <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">
                ROI Calculator
              </h1>
              <p className="text-lg sm:text-xl text-slate-300">
                Calculate rental yield, appreciation, and total returns for your property investment
              </p>
            </div>
