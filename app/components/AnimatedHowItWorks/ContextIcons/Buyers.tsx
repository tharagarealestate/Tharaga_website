...
const Buyer: React.FC<BuyerProps> = ({ x, delay = 0, color = '#FF6B35' }) => {
  return (
    <motion.g initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay, duration: 0.5 }}>
      <circle cx={x} cy={200} r={18} stroke="#111827" strokeWidth="3" fill="none" />
      <rect x={x - 24} y={220} width={48} height={34} rx={8} stroke="#111827" strokeWidth="3" fill="none" />
