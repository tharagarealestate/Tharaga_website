...
const navLinks = [
  { label: 'Properties', href: '/property-listing' },
  {
    ...
    href: '/tools',
    children: [
      { label: 'ROI Calculator',      href: '/tools?t=roi'          },
      { label: 'EMI Calculator',      href: '/tools?t=emi'          },
      { label: 'Budget Planner',      href: '/tools?t=budget'       },
      { label: 'Loan Eligibility',    href: '/tools?t=loan'         },
      { label: 'Neighborhood Finder', href: '/tools?t=neighborhood'  },
      { label: 'Property Valuation',  href: '/tools?t=valuation'    },
    ],
  },
