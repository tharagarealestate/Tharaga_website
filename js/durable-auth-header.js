...
// Extracted and adapted from the provided prompt snippet
//
// Paste-this prelude before this script if you want static styles and config inline:
//
// <script src="/login_signup_glassdrop/auth-gate.js" defer></script>
// <script>window.DURABLE_AUTH_URL = 'https://auth.tharaga.co.in/login_signup_glassdrop/';</script>
// <script>window.AUTH_NAV = window.AUTH_NAV || { profile: '/profile', dashboard: '/dashboard' };</script>
