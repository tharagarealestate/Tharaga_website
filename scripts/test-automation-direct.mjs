...
// Determine app directory (script might be in root or app directory)
const appDir = __dirname.includes('app') ? __dirname : join(__dirname, 'app')
...
async function testGetPropertyMarketingContext() {
  ...
  try {
    ...
    const context = data[0]?.get_property_marketing_context
    if (!context) {
